#from https://github.com/tanjimin/grad-cam-pytorch-light/blob/master/grad_cam.py
...
class InfoHolder():
    ...
    def hook(self, model, input, output):
        output.requires_grad=True # luca
...
def superimpose(input_img, heatmap):
    ...
    heatmap = np.swapaxes(heatmap, 0, 1)# luca
...
def grad_cam(model, input_tensor, heatmap_layer, truelabel=None):
    ...
    output = model(input_tensor.unsqueeze(0)) # luca
