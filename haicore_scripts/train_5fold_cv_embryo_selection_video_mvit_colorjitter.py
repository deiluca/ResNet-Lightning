    ...
    for clip_dur in [8]:
        for lr in [1e-3]:
            for i in range(5):
                ...
                outdir_name = f'epochs{epochs}_mvit_lr-autofind_cd{clip_dur}_uts{unif_temp_sub}_bs{batch_size}_img_size{vit_img_size}_wd{weight_decay}_opt-{opt}_cj-bn{cj_bn}_config2'
