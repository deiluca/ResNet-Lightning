...
nclasses = 3
resnet = 50
d = '/lsdf/kit/iai/projects/iai-aida/Daten_Deininger/projects/embryo_project/training_datasets/videos_allt'
resd = opj(d, 'results')
    ...
    for clip_dur in [8]:
        for lr in [1e-3]:
            for i in range(5):
                ...
                outdir_name = f'epochs{epochs}_resnet{resnet}_lr-autofind_cd{clip_dur}_uts{unif_temp_sub}_bs_{batch_size}'
